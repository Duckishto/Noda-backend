...
// GET /search?q=xxx&scope=posts|announcements|members|all
router.get('/', auth, async (req, res) => {
  ...
  try {
    ...
    if (['all', 'posts', 'home', 'knowledge'].includes(scope)) {
      ...
      results.posts = {
        total,
        data: data.map(p => ({ ...p, authorName: p.author.name, author: undefined })),
      }
    }
